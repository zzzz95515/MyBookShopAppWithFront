...
@ApiModelProperty("mnemonical id sequence of characters")
    ...
    public void setBookRate(List<BookRateEntity> bookRate) {
    ...
    public Double bookRating(){
        Integer sumRate= 0;
        for (BookRateEntity rate: bookRate){
            sumRate+=rate.getRateValue();
        }
        return Double.valueOf(sumRate/bookRate.size());
    }


    public Integer getNumOfRatesWithVal(Integer val){
        Integer num=0;
        for (BookRateEntity rate : bookRate){
