                            ...
                            validate.forEach(function (v) {
                                switch (v) {
                                    ...
                                    case'mail':
                                        ...
                                        break;
                                    case'key':
                                        if ($this.val() !== '' && !$this.val().replace(' ', '').match(/\d{5}/) && !$this.prop('disabled')) {
                    ...
                    $('[data-refreshshow]').on('click change', function (e) {
                        ...
                        switch (data) {
                            ...
                            case'genre':
                                ...
                                break;
                            case'author':
                                getData('/books/author1/' + $this.data('refreshid'), {
                                    offset: $this.data('refreshoffset'),
                                    limit: $this.data('refreshlimit')
                                });
                                break;
                                    ...
                                    if ($(slick.$slider).data('load')) {
                                        ...
                                        switch ($(slick.$slider).data('load')) {
                                            case'recommended':
                                                ...
                                                break;
                                            case'recent':
                                                sendData('/books/recent1')
                                                break;
                                            case'popular':
                                                sendData('/books/popular1')
                                                break;
                                        }
                                    }
                                }
